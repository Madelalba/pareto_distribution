...
// tarea 1 ejercicio 1 inciso iii
//este programa genera una caminata aleatoria para 1000 caminantes en dos dimensiones, me da la posicion promedio de cada variable
...
int main(){
     ...
     salida1.open("ej1iii.dat");
     salida2.open("promej1iii.dat");
     ...
     X.resize(d);                                // primera entrada indica coordenada x o y 
	...
	for (int i = 0; i < pasos-1; i++) { 
		  ...
		  salida2 << "  \t" << desplazamientocuadratico(distorigen); //cuarta columna desplazamiento cuadratico medio
		  salida2 << endl;                   
		  }
