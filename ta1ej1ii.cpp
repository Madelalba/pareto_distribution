//Maria del Alba Pacheco Blas.tarea 1 ejercicio 1 inciso ii 
//Este programa genera 1000 caminantes aleatorios en una dimension y me calcula la posicion promedio
//y el desplazamiento cuadratico promedio.
...
int main(){
     ...
     salida1.open("ej1ii.dat");
     salida2.open("promej1ii.dat");
     ...
     X.resize(d);                                // primera entrada indica coordenada x porque es una dimension
	...
	for (int i = 0; i < pasos-1; i++) { 
		  ...
		  salida2 << "  \t" << desplazamientocuadratico(distorigen); //tercera columna desplazamiento cuadratico medio
		  salida2 << endl;                   
		  }
